...
Singularity, Modal, Daytona, Vercel Sandbox, or Kubernetes. (Modal
additionally has direct and Nous-managed modes, selected via
terminal.modal_mode; Kubernetes has raw-Pod and Sandbox-CR
provisioners, selected via terminal.kubernetes.provisioner: pod | sandbox.)
